...
# Define the pipeline with TF-IDF and DecisionTree
...
print("Precision Score on test dataset for Decision Tree: %s" % precision_score(y_test, y_predict, average='micro'))
print("AUC Score on test dataset for Decision Tree: %s" % roc_auc_score(y_test, y_score, multi_class='ovo', average='macro'))
print("F1 Score on test dataset for Decision Tree: %s" % f1_score(y_test, y_predict, average="weighted"))
...
model_path = os.path.join(model_dir, 'DCclass.pkl')
print(model_path)
# Store the model
