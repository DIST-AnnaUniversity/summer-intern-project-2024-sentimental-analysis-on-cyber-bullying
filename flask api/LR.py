...
# Define the pipeline with TF-IDF and LogisticRegression
...
print("F1 Score on test dataset for Logistic Regression: %s" % f1_score(y_test, y_predict, average="weighted"))
...
model_path = os.path.join(model_dir, 'LRmodel.pkl')
print(model_path)
# Store the model
